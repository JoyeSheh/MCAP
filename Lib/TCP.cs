...
namespace Trnsprt.TCP
{
    internal sealed class TCPFactory
    {
        ...
        public static TCPFactory Instance { get { return instance.Value; } }
    ...
    internal class TCPServer : TCPBase
    {
        ...
        public TCPServer(IPAddress ip, int port, EventHandler<ReceiveEventArgs> onReceiveData) : base(ip, port, onReceiveData)
        {
            localPort = port;
        }
    ...
    internal class TCPClient : TCPBase
    {
        ...
        public TCPClient(IPAddress ip, int port, EventHandler<ReceiveEventArgs> onReceiveData) : base(ip, port, onReceiveData)
        {
